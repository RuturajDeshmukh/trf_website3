...
<html>
    <head>
      ...
      <link rel="stylesheet" href="leaderboard_style3.css">
              ...
              <div class="dropdown" id="leaddrp">
                  ...
                  <?php 
                    ...
                    <div id="myDropdown" class="dropdown-content">
                      ...
                      {?>
                        <a class="headanch" href="javascript:void(0)" id="<?php echo $k ?>" name="<?php echo $k ?>"><?php echo $row['quizName'];?></a>
                        <?php
                        $k++;
                        } 
                        ?>
    ...
    if(empty($_POST['dep']) AND empty($_POST['year']))
        ...
        $quer = "SELECT `user_id`, `username`, `Branch`, `Year` FROM `users` WHERE `user_id`=$iid ";  
          ...
          ?>
                  ...
                  <td class="list__cell"><span class="list__value"><?php echo $ran+1;?></span></td>
  ...
  <ul class="radul">
    ...
    <li class="radinp">
      ...
      <div class="bullet">
		...
		<li class="radinp">
      <input type="radio" name="1" id="elecs" value="Electronics">
      <label for="Electronics">Electronics</label>
      <div class="bullet">
        <div class="line zero"></div>
        <div class="line one"></div>
    ...
    <li class="radinp">
      <input type="radio" name="2" id="fy"  value="FY">
      ...
      <div class="bullet">
        ...
        <li class="radinp">
      <input  type="radio" name="2" id="SY" value="SY">
      ...
      <div class="bullet">
        ...
        <li class="radinp">
      <input  type="radio" name="2" id="ty" value="TY">
      ...
      <div class="bullet">
        ...
        <li class="radinp">
      <input  type="radio" name="2" id="final" value="BE">
      ...
      <div class="bullet">
        ...
        function changeFunction(){
          ...
          {
            echo ("<script>window.alert('Please login to see Leaderboard');
