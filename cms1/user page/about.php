		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="about.php?user=<?php echo $id;?>">About Me</a></li>
			...
			<section class="ftco-section-no-padding bg-light">
				<div class="hero-wrap">
					...
					<div class="d-flex" style="background-image: url(images/bg5.jpg);">
						...
						<div class="container py-4 my-2" style="margin-top: 10% !important;">
    <div class="row">
        <div class="col-md-4 pr-md-5">
            <img class="w-100 rounded border" src="../admin/images/<?php echo $img; ?>">
          
        </div>
        <div class="col-md-8">
            <div class="d-flex align-items-center">
                <h2 class="font-weight-bold m-0">
                   <?php echo $r1['user_firstname']."  ".$r1['user_lastname']  ; ?> 
                </h2>
            </div>
            ...
            <section class="mt-4">
                <div class="tab-content py-4" id="myTabContent">
                    <div class="tab-pane py-3 fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <dl class="row mt-4 mb-4 pb-3" style="padding-left: 0;">
                            <dt class="col-sm-7" style="margin-top: 2%;">GR Number</dt>
                            <dd class="col-sm-5" style="margin-top: 2%;"><?php echo $r1['user_id']; ?></dd>
                            
                            
                            <dt class="col-sm-7" style="margin-top: 2%;">Email address</dt>
                            <dd class="col-sm-5" style="margin-top: 2%;">
                                <a href="aniket.ghorpade18@vit.edu"><?php echo $r1['user_email']; ?></a>
                            </dd>
                            
                            <dt class="col-sm-7" style="margin-top: 2%;">Branch</dt>
                            <dd class="col-sm-5" style="margin-top: 2%;"><?php echo $r1['Branch']; ?></dd>
                            
                            <dt class="col-sm-7" style="margin-top: 2%;">Year</dt>
                            <dd class="col-sm-5" style="margin-top: 2%;"><?php echo $r1['Year']; ?></dd>
                        </dl>
