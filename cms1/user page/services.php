...
<script src="https://cdnjs.cloudflare.com/ajax/libs/easy-pie-chart/2.1.6/jquery.easypiechart.min.js"></script>
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="services.php?user=<?php echo $id;?>"><b>Projects</b></a></li>
      ...
      $count=0;
      $id=$_GET['user'];
      $qry="SELECT * FROM `project` ORDER BY date DESC ";
      $runn=mysqli_query($con,$qry);
	  
      while($row=mysqli_fetch_assoc($runn))
      {
        $str=$row['teamdid'];
        $arr=explode(',',$str);//array of teamids
        ...
        foreach($arr as $s1)
        {
          if($s1==$id){
			...
			foreach($arr1 as $i){
				...
				//echo $i;
				$qry1= "SELECT * FROM `tags` WHERE `id`='$i'  " ;
