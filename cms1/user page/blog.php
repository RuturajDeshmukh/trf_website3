	    			...
	    			<div class="col-lg-12">
	    				<div class="row">
			    			<div class="col-md-12">
				              ...
				              <h3 class="mb-2"><a href="../post.php?p_id=<?php echo $arr1[$i]['post_id']; ?>"><?php echo $arr1[$i]['post_title']; ?></a></h3>
				              <div class="meta-wrap">
												<p class="meta">
				              		<span><?php echo $arr1[$i]['post_date']; ?></span>
				              		<span><a href="javascript:void(0)"><?php echo $arr1[$i]['post_tags']; ?></a></span>
