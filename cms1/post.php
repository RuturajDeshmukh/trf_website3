                     ...
                     <ul class="navbar-nav">
                       ...
                       <?php //include("includes/header.php");
						...
						<li class="nav-item dropdown" style="width: 100px;">
                           <a class="nav-link dropdown-toggle headeranchors" href="#" id="navbarDropdown" role="button"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <img class=" rounded-circle" src="../cms1/user page/blog.php?user=<?php echo $_SESSION['user_image']?>" style="width: 50%; height: 50%;">
                           </a>
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <div class="row blog-entries element-animate">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            <img src="admin/images/<?php echo $post_image; ?>" alt="Image" class="img-fluid mb-5" >
             <div class="post-meta">
                        <span class="author mr-2" style="font-size: 18px;"><img style="height: 40px; width: 40px;" src="admin/images/<?php echo $p_author_image ?>" alt="Image" class="mr-2"> <?php echo $post_author ?></span>&bullet;
